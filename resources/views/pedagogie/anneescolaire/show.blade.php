    ...
    <div class="left">
        ...
        <div class="right">
            ...
            <div class="right-subtilte">
                ...
                <div class="d-flex">
                    <button class=" btn btn-info mx-1" id="openModalBtn">Ajouter une classe</button>
                    <a href="{{route('day.index' , ['id' => $anneescolaire->id])}}">
                        <button class="btn btn-dark">Jour de cours</button>
                    </a>
                </div>
            </div>
      ...
      <div class="right-content">
            <div class="right-content-tilte">
                ...
                <div class="col  text-center p-2"><h6>Nom de la classe</h6></div>
                <div class="col  text-center p-2"><h6>Nombre d'étudiant</h6></div>
                <div class="col  text-center p-2"><h6>Actions</h6></div>                    
            </div>
            
                <div class="right-content-subtitle">
                <p hidden>{{$nb_day_hours = 0}}</p>
                    @if($anneescolaire->classes->count() >= 1)
                    @foreach ($cas as $annee)
                        ...
                        <p hidden>{{$nb_day_hours = 1 + $nb_day_hours}}</p>
                            ...
                            <div class="col text-center p-2">{{ $annee->classes->nom }}</div>
                            <div class="col text-center p-2">{{ $annee->etudiants->count()}}</div>
                            <div class="col text-center py-2 p-0">
                                <a href="{{ route('classeanneescolaire.show', ['id' => $annee->classes->id , 'id_annee' => $annee->anneescolaires->id]) }}">
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    <div id="dateModal" class="modal">
        <div class="modal-content">
            ...
            <h5 class="d-flex justify-content-center pb-4"></h5>
            <form id="dateForm" method="POST" action="{{ route('classeanneescolaire.storeAdmin' , ['id' => $id_anneescolaire]) }}">
                @csrf
                <select name="nom" id="" class="form-control">
                <option value="" disabled selected>Choisir une classe</option>
                    @foreach ($classe as $classes)
                        <option value="{{$classes->id}}">{{$classes->nom}}</option>
                    @endforeach
                </select>
                <br>
