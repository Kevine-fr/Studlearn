        ...
        <div class="right">
            ...
            <div class="right-subtilte">
                <div class="d-flex">
                    ...
                    <h5 class="text-secondary">Classe\</h5>
                    </a>
                    <a href="">
                    <h5 class="text-secondary">Année-scolaire ({{$nb_annneescolaire}})</h5>
                    </a>
                </div>
                <button class="btn btn-info" id="assignedModal">Inscrire un étudiant</button>
            </div>

      <div class="right-content">
            <div class="right-content-tilte">
                <div class="col  text-center p-2"><h6>ID</h6></div>
                <div class="col  text-center p-2"><h6>Début de l'année</h6></div>
                <div class="col  text-center p-2"><h6>Fin de l'année</h6></div>
                <div class="col  text-center p-2"><h6>Nombre de classes</h6></div>
                <div class="col  text-center p-2"><h6>Actions</h6></div>                    
            </div>
            
                <div class="right-content-subtitle">
                    @if($nb_classeannneescolaire >= 1)
                    @foreach ($classeanneescolaires as $classe)
                    <div class="right-content-subtitle-row">
                        <div class="col  text-center p-2 text-secondary">{{$classe->id}}</div>
                        <div class="col  text-center p-2">{{$classe->date_de_debut}}</div>
                        <div class="col  text-center p-2">{{$classe->date_de_fin}}</div>
                        <div class="col  text-center p-2">{{$classe->classes ? $classe->classes->count() : 0}}</div>
