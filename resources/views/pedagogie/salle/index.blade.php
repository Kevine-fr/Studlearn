...
<body>
    ...
    <div class="left">
        ...
        <div class="right">
            ...
            <div class="right-subtilte">
                <h5 class="text-secondary">Salle ({{$nb_salle}})</h5>
                <button class="btn btn-info" id="openAddForAdmin">Ajouter une salle</button>
            </div>
      ...
      <div class="right-content">
            <div class="right-content-tilte">
                ...
                <div class="col  text-center p-2"><h6>Nbr Place</h6></div>
                ...
                <div class="right-content-subtitle">
                    ...
                    <div class="right-content-subtitle-row">
                        <div class="col  text-center p-2 text-secondary">{{$salles->id}}</div>
                        <div class="col  text-center p-2">{{$salles->nom}}</div>
                        <div class="col  text-center p-2">{{$salles->taille}}</div>
                    ...
                    @else
                        <div class="d-flex justify-content-center text-secondary py-2">
                            Aucune salle n'a été enregistrer !
                        </div>
                    @endif
                </div>
            </div>
    ...
    <div class="left">
        ...
        <div class="right">
            ...
            <div class="right-subtilte">
                <h5 class="text-secondary">Salle ({{$nb_salle}})</h5>
                <button class="btn btn-info" id="openModalBtn">Ajouter une salle</button>
            </div>
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    <div id="dateModal" class="modal">
        <div class="modal-content">
            ...
            <h5 class="d-flex justify-content-center pb-4">Salle</h5>
            <form id="dateForm" method="POST" action="{{ route('salle.store') }}">
                @csrf
                ...
                <div class="form-group py-2">
                    <label for="endYear">Nombre de place</label>
                    <input type="number" id="endYear" name="taille" required class="form-control">
                </div>
    ...
    <div id="addForAdmin" class="modal">
        <div class="modal-content">
            <span class="close-btn d-flex justify-content-end">&times;</span>
            <h5 class="d-flex justify-content-center pb-4">Salle</h5>
            <form id="dateForm" method="POST" action="{{ route('salle.storeAdmin') }}">
                @csrf
                <div class="form-group">
                    <label for="startYear">Nom</label>
                    <input type="text" id="startYear" name="nom" required class="form-control">
