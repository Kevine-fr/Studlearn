...
<body>
    ...
    <div class="left">
        ...
        <div class="right">
            ...
            <div class="right-subtilte">
                <h5 class="text-secondary">Cours ({{$nb_cours}})</h5>
                <button class="btn btn-info" id="openAddForAdmin">Ajouter un cours</button>
            </div>
            ...
            <div class="right-content-tilte">
                ...
                <div class="right-content-subtitle">
                    ...
                    <div class="right-content-subtitle-row">
                        <div class="col  text-center p-2 text-secondary">{{$cour->id}}</div>
                        <div class="col  text-center p-2">{{$cour->nom}}</div>
    ...
    <div class="left">
        ...
        <div class="right">
            ...
            <div class="right-subtilte">
                <h5 class="text-secondary">Cours ({{$nb_cours}})</h5>
                <button class="btn btn-info" id="openModalBtn">Ajouter un cours</button>
            </div>
...
<script>
    ...
    <div id="addForAdmin" class="modal">
        <div class="modal-content">
            ...
            <h5 class="d-flex justify-content-center pb-4">Cours</h5>
            <form id="dateForm" method="POST" action="{{ route('cours.storeAdmin') }}">
                @csrf
                <div class="form-group">
                    <label for="startYear">Nom</label>
                    <input type="text" id="startYear" name="nom" required class="form-control">
                </div>
                <select name="id_secretariat" id="" class="form-control" required>
    ...
    <div id="dateModal" class="modal">
        <div class="modal-content">
            <span class="close-btn d-flex justify-content-end">&times;</span>
            <h5 class="d-flex justify-content-center pb-4">Cours</h5>
            <form id="dateForm" method="POST" action="{{ route('cours.store') }}">
                @csrf
                <div class="form-group">
                    <label for="startYear">Nom</label>
                    <input type="text" id="startYear" name="nom" required class="form-control">
