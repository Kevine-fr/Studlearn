        ...
        <div class="right">
            ...
            <div class="right-subtilte">
                <div class="d-flex">
                    ...
                    <h5 class="text-secondary">Heure ({{$nb_hour}})</h5>
                </div>
                <button class="btn btn-info" id="openModalBtn">Ajouter un intervalle</button>
            </div>

      <div class="right-content">
            <div class="right-content-tilte">
                <div class="col  text-center p-2"><h6>ID</h6></div>
                <div class="col  text-center p-2"><h6>Heure de depart</h6></div>
                ...
                <div class="right-content-subtitle">
                    @if($nb_hour >= 1)
                    @foreach ($hour as $heure)
                    <div class="right-content-subtitle-row">
                        <div class="col  text-center p-2 text-secondary">{{$heure->id}}</div>
                        <div class="col text-center p-2">{{ Carbon\Carbon::parse($heure->heure_de_debut)->format('H:i') }}</div>
                        <div class="col text-center p-2">{{ Carbon\Carbon::parse($heure->heure_de_fin)->format('H:i') }}</div>
                        <div class="col  text-center py-2 p-0">
                            <a href="{{route('hour.show' , ['id' => $heure->id])}}">
...
<script>
    ...
    <div id="dateModal" class="modal">
        <div class="modal-content">
            ...
            <h5 class="d-flex justify-content-center pb-4">Heure</h5>
            <form id="dateForm" method="POST" action="{{ route('hour.store') }}">
                @csrf
                <div class="form-group">
                    <label for="startYear">Heure de début</label>
                    <input type="time" id="startYear" name="heure_de_debut" required class="form-control">
                </div>
                <div class="form-group py-2">
                    <label for="endYear">Heure de fin</label>
                    <input type="time" id="endYear" name="heure_de_fin" required class="form-control">
                </div>
