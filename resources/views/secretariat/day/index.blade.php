    ...
    <div class="left">
        ...
        <div class="right">
            ...
            <div class="right-subtilte">
                ...
                <div class="d-flex">
                    ...
                    <h5 class="text-secondary">Jour ({{$nb_day}})</h5>
                </div>
                    @if(session('error'))
      ...
      <div class="right-content">
            <div class="right-content-tilte">
                ...
                <div class="col  text-center p-2"><h6>Jour de cours</h6></div>
                <div class="col  text-center p-2"><h6>Actions</h6></div>                    
            </div>
            
                <div class="right-content-subtitle">
                <p hidden>{{$nb_days = 0}}</p>
                    @if($nb_day >= 1)
                    @foreach ($day as $jour)
                    <p hidden>{{$nb_days = 1 + $nb_days}}</p>
                    <div class="right-content-subtitle-row">
                        <div class="col  text-center p-2 text-secondary">{{$nb_days}}</div>
                        <div class="col text-center p-2">{{$jour->date }}</div>
                        <div class="col  text-center py-2 p-0">
                        <a href="{{route('day.show' , ['id' => $jour->id])}}">
...
<script>
    ...
    <div id="dateModal" class="modal">
        <div class="modal-content">
            ...
            <h5 class="d-flex justify-content-center pb-4">Jour</h5>
            <form id="dateForm" method="POST" action="{{ route('day.store' , ['id' => $id_annee]) }}">
                @csrf
                <div class="form-group">
                    <label for="startYear">Date de cours</label>
                    <input type="date" id="startYear" name="date" required class="form-control">
                </div>
                    <input type="numeric" name="id_annee_scolaire" class="form-control" hidden>
